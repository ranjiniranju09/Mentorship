...
<body>
  <div class="container">
    ...
    <div class="cover">
      <div class="front">
        <img src="{{ asset('images/studd1.jpg') }}" alt="">
        <div class="text">
      ...
      <div class="back">
      <img class="backImg" src="{{ asset('images/studd1.jpg') }}" alt="">
        <div class="text">
    ...
    <div class="forms">
        <div class="form-content">
          ...
          <img class="forstulogo" src="{{ asset('images/logo forstu.png') }}" alt="Your Logo">
